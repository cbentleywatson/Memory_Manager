...
// Should be modified  for use on the esp32's elf files without needing any external headers
typedef struct
{
	char magic[4];
...
int main()
{
	...
	ifstream myfile("simple_lib_d/simple_lib.o");
