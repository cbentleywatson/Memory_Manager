...
#include <freertos/FreeRTOS.h>  // present
#include <freertos/task.h> // present
#include <freertos/semphr.h> // present
#if CONFIG_IDF_TARGET_ESP32
#include "soc/dport_reg.h" //present
...
#include "esp_ipc.h"
#endif
#include "esp_attr.h"// present
#include "esp_intr_alloc.h" // present
#include "esp_spi_flash.h" // Presnt
#include "esp_log.h" // present
#include "esp_cpu.h"
